...
javac -cp "C:/Program Files/Apache Software Foundation/Tomcat 7.0/lib/servlet-api.jar";"C:/Program Files/Apache Software Foundation/Tomcat 7.0/lib/jsp-api.jar";. -d WebContent/WEB-INF/classes src/com/bean/*.java src/com/pe/*.java src/com/util/*.java src/com/tld/*.java || goto :error
